  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setAvgRating(currentProduct.rating_average ?? 0);
          ...
          <div className="w-full md:w-2/5 flex flex-col">
            ...
            <div className="flex gap-4 mt-auto">
              ...
              <button
                ...
                className="flex-1 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white py-3.5 rounded-lg font-bold shadow-lg shadow-red-900/40 transition transform active:scale-95"
              >
                ซื้อเลย
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-black/30 p-4 rounded-lg border border-white/5">
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li className="flex justify-between">
                    <span>Weight:</span>{" "}
                    <span className="text-white">350g</span>
                  </li>
                  <li className="flex justify-between">
                    <span>Color:</span>{" "}
                    <span className="text-white">Black / Red</span>
                  </li>
                </ul>
              </div>
            </div>
