  ...
  return (
    <div className="min-h-screen bg-[#0f0f12] text-white font-sans pb-20">
      <div className="container mx-auto px-4 mt-6 max-w-6xl">
        ...
        <div className="mb-16">
          <h3 className="text-xl font-bold mb-6 flex items-center gap-3">
            <span className="w-1.5 h-8 bg-gray-600 rounded-full block"></span>{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[1, 2, 3, 4].map((i) => (
              ...
              >
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-gray-700 to-black border border-white/10 flex items-center justify-center font-bold text-gray-500">
                  U{i}
                </div>
                <div>
                  ...
                  <p className="text-sm text-gray-400 italic">
                    "
                    {i % 2 === 0
                      ? "จัดส่งไวมาก แพ็คของมาดี สินค้าตรงปกครับ"
                      : "ใช้งานดีมาก เสียงเงียบ ปุ่มนิ่ม คุ้มราคาที่สุด"}
                    "
                  </p>
                </div>
              </div>
