...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  const imageSrc = product.imageUrl ?? product.image_url ?? 'https://placehold.co/400x400';
  ...
  return (
    ...
    >
      ...
      <figure className="h-[220px] bg-white p-6 relative flex items-center justify-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-black/10 opacity-0 group-hover:opacity-100 transition duration-300" aria-hidden="true" />
      </figure>
