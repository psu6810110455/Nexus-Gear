            ...
            <div className="flex items-start justify-between pl-3">
              <div>
                <header className="flex items-center gap-3 mb-2">
                  ...
                  {addr.isDefault && <span className="bg-[#FF0000]/15 text-[#FF0000] text-[9px] px-2 py-0.5 rounded border border-[#FF0000]/30 font-['Kanit'] tracking-wider">ค่าเริ่มต้น</span>}
                </header>
                ...
                <footer className="text-xs text-[#F2F4F6]/40 mt-2 flex items-center gap-1">
                  <span className="text-[#990000]">เบอร์โทร:</span> {addr.phone}
                </footer>
              </div>
