            ...
            {menuItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition text-left ${isActive ? "bg-red-600/20 text-red-500 border-l-2 border-red-500 font-semibold" : "text-gray-500 hover:text-gray-200 hover:bg-white/5"}`}
                >
