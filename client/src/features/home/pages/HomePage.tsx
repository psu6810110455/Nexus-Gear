...
const MOCK_PRODUCTS = [
  {
    ...
    price: 34990,
    imageUrl:
      "https://dlcdnwebimgs.asus.com/gain/44268636-6202-4048-96bd-276632057342/w800",
  },
  {
    id: 2,
    name: "Black Shark 5",
    price: 18900,
    imageUrl: "https://m.media-amazon.com/images/I/61imgK9J+lL.jpg",
  },
  {
    id: 3,
    name: "HyperX Cloud",
    price: 2990,
    imageUrl:
      "https://row.hyperx.com/cdn/shop/products/hyperx_cloud_alpha_red_1_main_900x.jpg",
  },
  {
    id: 4,
    name: "Kishi V2",
    price: 3590,
    imageUrl: "https://m.media-amazon.com/images/I/61iXE1nZkGL.jpg",
  },
  {
    id: 5,
    name: "ROG Kunai 3",
    price: 3990,
    imageUrl:
      "https://dlcdnwebimgs.asus.com/gain/57F833C8-94D9-4824-913A-98C152B336A1",
  },
  {
    id: 6,
    name: "Flydigi Apex 3",
    price: 2990,
    imageUrl:
      "https://m.media-amazon.com/images/I/61K-x+w+pXIL._AC_SL1500_.jpg",
  },
  {
    id: 7,
    name: "Finger Sleeve",
    price: 190,
    imageUrl: "https://m.media-amazon.com/images/I/61+y+w+pXIL._AC_SL1500_.jpg",
  },
  {
    id: 8,
    name: "Cooler Fan",
    price: 990,
    imageUrl: "https://m.media-amazon.com/images/I/61t-XhJ-xRL.jpg",
  },
];
      ...
      {showWelcome && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/90 backdrop-blur-sm transition-opacity duration-500">
          <div className="bg-black border-2 border-red-600 rounded-[30px] p-8 w-full max-w-sm mx-4 shadow-[0_0_60px_rgba(220,38,38,0.6)] flex flex-col items-center text-center relative overflow-hidden">
            ...
            <h2 className="text-xl font-bold text-white mb-1 tracking-wider mt-4">
              WELCOME TO NEXUS GEAR
            </h2>
            <p className="text-white text-md mb-6 font-medium">
              ยินดีต้อนรับสู่ NEXUS GEAR
            </p>
            ...
            <button
              ...
              className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 rounded-lg transition-all shadow-lg shadow-red-900/50 mt-2"
            >
              เข้าสู่เว็บไซต์
            </button>
          </div>
